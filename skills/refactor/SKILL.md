...
4. **Record Evidence**: After each verification, call `evidence_record(type="typecheck", command="<cmd>", exit_code=<code>, output_snippet="<output>")`
...
- Preview before applying (use ast-grep MCP tools with dryRun where supported)
